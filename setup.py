...
setup(
    ...
    entry_points={
        'console_scripts': [
            'atsemapper=leafletfa_utils.atsemapper.main:main',
            'atseviz=leafletfa_utils.atseviz.main:main',
        ],
    },
    author="Karin Isaev",
    ...
    url="https://github.com/yourusername/LeafletFA-utils",
)